...
import Models.SingleTargetTower;
...
public class TestTowerController {
    ...
    public void testDetectTargets() throws Exception {
        ...
        List<Critter> detectedTargets1 = controller.detectTargets(singleTargetTower, critterGroup);
        assertEquals(4, detectedTargets1.size());

        singleTargetTower.setRange(5);
        List<Critter> detectedTargets2 = controller.detectTargets(singleTargetTower, critterGroup);
    ...
    public void testSelectTargets() throws Exception {
        ...
        List<Critter> selectedTargets1 =
                controller.selectTargets(singleTargetTower, detectedTargets1);
        ...
        List<Critter> detectedTargets2 = controller.detectTargets(multiTargetsTower, critterGroup);
        List<Critter> selectedTargets2 =
                controller.selectTargets(multiTargetsTower, detectedTargets2);
    ...
    public void testAttackTargets() throws Exception {
        ...
        assertEquals(85, (long) critter1.getHealth());
        assertEquals(40, (long) critter1.getSpeed());
        assertEquals(true, critter1.isSlowed());

        controller.attackTargets(multiTargetsTower, targets);
        assertEquals(80, (long) critter1.getHealth());
        assertEquals(40, (long) critter1.getSpeed());
        assertEquals(true, critter1.isSlowed());
