...
public class Map {
    ...
    /** name of the map */
    private int width;
    /** width in number of cells of the map */
    private int height;
    /** height in number of cells of the map */
    private Cell[][] cells;
    /** 2D array of cells which comprise the total map */
    private Path start;
    /** the start tile */
    private Path end;
    /** the end tile */
    ...
    /**
     * Map constructor which sets the width, height, name and initialises a blank map with only
     * scenery cells
     */
