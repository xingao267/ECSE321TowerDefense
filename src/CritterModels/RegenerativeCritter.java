...
public class RegenerativeCritter extends Critter {
	...
	/**
	 * Regenerates the a certain amount of health points every seconds that the
	 * critter is not being hit, depending on the game level.
	 * 
	 * @param level
