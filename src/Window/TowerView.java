...
public class TowerView implements ITowerObserver {
            ...
            try {
                ...
                if (this.tower.getTowerType().equals(Constants.REGULAR_TOWER_TYPE)) {
                	...
                	getImage(Constants.BOMBER_TOWER_SHEET, this.tower);
                	 ...
                	 getImage(Constants.LONGRANGE_TOWER_SHEET, this.tower);
                } else if (this.tower.getTowerType().equals(Constants.RAPID_FIRE_TOWER_TYPE)) {
                	getImage(Constants.RAPID_FIRE_TOWER_SHEET, this.tower);
                } else if (this.tower.getTowerType().equals(Constants.DECELERATOR_TOWER_TYPE)) {
                	getImage(Constants.DECELERATOR_TOWER_SHEET, this.tower); 
                } else {
    ...
    private void getImage(String towerType, Tower tower){
    	
    	try {
			sheetImg = ImageIO.read(new File(towerType));
		} catch (IOException e) {
